...
const ReportDynamicEdit = () => {
    ...
    // const [deptId, setDeptId] = useState(deptUniqueId)
    ...
    async function getDynamicData() {
        ...
        var fd = new FormData;
        fd.append("dept_id", deptUniqueId)
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                ...
                <div className="py-4">
                    ...
                    <form className="space-y-8 divide-y divide-gray-200" id="addExpType" onSubmit={handleSubmit}>
                        <h1>Add dynamic report fields under Dept: {deptName}</h1>
                        ...
                        {/* <div className="sm:items-start">
                            ...
                            <div className="mt-1 sm:mt-0 sm:col-span-2">
                                ...
                                >
                                    ...
                                    {
                                        depts.map((dept) => (
                                            <option value={dept.id} key={dept.id} selected={dept.id==deptUniqueId?'selected':''}>{dept.identifier}</option>
                                        ))
                                    }
                                </select>
                            </div>
...
export default ReportDynamicEdit